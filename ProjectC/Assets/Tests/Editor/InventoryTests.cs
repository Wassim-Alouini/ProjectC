...
//         _sampleItem = new Item(ItemType.Weapon, "TestWeapon", 100, 25, ItemRarity.Rare, MaterialType.Steel);
//     }
//     [Test]
...
//         inventory.AddItem(_sampleItem);
//         Assert.Throws<InvalidOperationException>(() => inventory.AddItem(new Item(ItemType.Weapon, "Test2", 150, 30, ItemRarity.Common, MaterialType.Wood)));
//     }
